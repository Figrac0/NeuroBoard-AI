...
On an existing codebase you are almost never building a capability from zero — you're _modifying_ one.
...
On a 0→1 project the volume of _new_ decisions is huge and there is no source of truth yet. Spec Kit's
